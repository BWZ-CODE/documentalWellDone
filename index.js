window.addEventListener("scroll", function(){
    ...
    text.classList.toggle("abajo",this.window.scrollY>161)
...
window.addEventListener("scroll", function(){
    ...
    text2.classList.toggle("partTwoTextActive",this.window.scrollY>525)
})

window.addEventListener("scroll", function(){
    var text3 = document.querySelector(".partThreeText");
    text3.classList.toggle("partThreeTextActive",this.window.scrollY>1089)
})


window.addEventListener("scroll", function(){
    var boxe1 = document.querySelector(".active1");
    boxe1.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe2 = document.querySelector(".active2");
    boxe2.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe3 = document.querySelector(".active3");
    boxe3.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe4 = document.querySelector(".active4");
    boxe4.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe5 = document.querySelector(".active5");
    boxe5.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe6 = document.querySelector(".active6");
    boxe6.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe7 = document.querySelector(".active7");
    boxe7.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe8 = document.querySelector(".active8");
    boxe8.classList.toggle("boxActive",this.window.scrollY>2770)
    var boxe9 = document.querySelector(".active9");
    boxe9.classList.toggle("boxActive",this.window.scrollY>2770)
})
